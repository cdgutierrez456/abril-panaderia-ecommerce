...
export async function createProduct(form: FormData) {
  ...
  // Todo producto nace con una variante sin tamaño: el stock siempre vive en
...
export async function saveVariant(form: FormData) {
  ...
  // Los índices únicos rechazan tamaños repetidos y una segunda variante sin
  // tamaño. Eso fallaba en silencio: el formulario volvía como si nada.
  const { error } = id
