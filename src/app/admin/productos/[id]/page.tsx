    ...
    <>
      ...
      <section className="mt-14 border-t border-line pt-8">
        ...
        <p className="mt-2 max-w-lg text-xs text-faint">
          Deja el tamaño vacío para un producto de un solo formato (un postre por porción). Agrega una fila por tamaño
          cuando sí los tenga (10, 20, 30 porciones…).
        </p>
        ...
        <form action={saveVariant} className="flex flex-wrap items-center gap-2 pt-4">
          <input type="hidden" name="product_id" value={product.id} />
          <input className="field w-28" name="label" placeholder="Tamaño" />
